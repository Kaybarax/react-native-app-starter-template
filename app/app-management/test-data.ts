...
export const TEST_RECIPES: Array<Recipe> = [
  {
    id: 'qwertyytrewqqwertyytrewqqwerty1_',
    name: 'Jolof',
    is_vegetarian: false,
    is_vegan: false,
    ...
    status_ref_key_value: 'ACT',
  },
  {
    id: 'qwertyytrewqqwertyytrewqqwerty2_',
    name: 'Lacatte',
    is_vegetarian: true,
    is_vegan: false,
    ingredients: ['Ingredient A', 'Ingredient B', 'Ingredient C', 'Ingredient D'],
  ...
  {
    id: 'qwertyytrewqqwertyytrewqqwerty3_',
    name: 'Postir',
    is_vegetarian: true,
    is_vegan: true,
    ingredients: ['Ingredient A', 'Ingredient B', 'Ingredient C', 'Ingredient D'],
  ...
  {
    id: 'qwertyytrewqqwertyytrewqqwerty4_',
    name: 'Casserole',
    is_vegetarian: false,
    is_vegan: false,
    ingredients: ['Ingredient A', 'Ingredient B', 'Ingredient C', 'Ingredient D'],
  ...
  {
    id: 'qwertyytrewqqwertyytrewqqwerty5_',
    name: 'Frijoles',
    is_vegetarian: true,
    is_vegan: true,
    ingredients: ['Ingredient A', 'Ingredient B', 'Ingredient C', 'Ingredient D'],
...
export const TEST_RECIPES_PHOTOS: Array<RecipeImage> = [
  {
    id: '_1qwertyytrewqqwertyytrewqqwerty',
    recipe_id: TEST_RECIPES[0].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_2qwertyytrewqqwertyytrewqqwerty',
    recipe_id: TEST_RECIPES[1].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_2qwertyytrewqqwertyytrewqqwer1_',
    recipe_id: TEST_RECIPES[1].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_2qwertyytrewqqwertyytrewqqwer2_',
    recipe_id: TEST_RECIPES[1].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_3qwertyytrewqqwertyytrewqqwerty',
    recipe_id: TEST_RECIPES[2].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_4qwertyytrewqqwertyytrewqqwerty',
    recipe_id: TEST_RECIPES[3].id,
    image_url: '',
    image_file: '',
  },
  {
    id: '_5qwertyytrewqqwertyytrewqqwerty',
    recipe_id: TEST_RECIPES[4].id,
    image_url: '',
    image_file: '',
  },
];
